library angulardart_flight_school.web.addressbook.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"tooltip": (o) => o.tooltip,
  r"contact": (o) => o.contact,
  r"search": (o) => o.search,
  r"contacts": (o) => o.contacts,
  r"id": (o) => o.id,
  r"firstName": (o) => o.firstName,
  r"lastName": (o) => o.lastName,
  r"address": (o) => o.address,
  r"phone": (o) => o.phone,
  r"update": (o) => o.update,
  r"save": (o) => o.save
};
final Map<String, FieldSetter> setters = {
  ...
  r"tooltip": (o, v) => o.tooltip = v,
  r"contact": (o, v) => o.contact = v,
  r"search": (o, v) => o.search = v,
  r"contacts": (o, v) => o.contacts = v,
  r"id": (o, v) => o.id = v,
  r"firstName": (o, v) => o.firstName = v,
  r"lastName": (o, v) => o.lastName = v,
  r"address": (o, v) => o.address = v,
  r"phone": (o, v) => o.phone = v
};
